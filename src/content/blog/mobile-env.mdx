...
This guide assumes you are on a Mac. If you're on Windows, that's a personal problem. To get a deeper sense of what I'm working with, you can check out my [machine config](/dev-env) as a whole.
...
Using [Homebrew](https://brew.sh/) (or whatever your preferred package manager), you'll need the following packages:

```bash
brew install gnupg applesimutils git node watchman fastlane aria2
```

I also recommend [dotenvx](https://dotenvx.com/docs/quickstart) for handling environment variables. It can be installed globally as well.
...
I prefer the **[xcodes](https://github.com/XcodesOrg/XcodesApp)** library for Xcode version management.
...
At this point, your machine should be setup for native development. If you're using Expo, I highly recommend installing [Expo Orbit](https://docs.expo.dev/build/orbit/).
